                ...
                <div class="row   justify-content-md-start novi-disabled">
                  <div class="col-11 " style="margin-left:3%;margin-right:3%">
                    <div style="padding:8%" class="section-lg">
                          ...
                          <div class="row row-30 ">    
                              ...
                              <div class="form-group">
                                <div class="select-wrap">
                                  <select class="select2" id="simple-select" required name="tipo" data-select2-options='{"placeholder":"Tipo"}'>
                                    ...
                                    <option  {{ old('tipo') == "Inbound" ? 'selected' : '' }} value="Inbound">Inbound Services</option>
                                    <option  {{ old('tipo') == "Outbound" ? 'selected' : '' }} value="Outbound">Outbound Services</option>
                                  </select>                              
                                </div>
                              </div>                    
                            </div>                    
                            <div class="col-md-12">
                              <div class="form-group">
                                <div class="input-group">
                                  ...
                                  <input  class="form-control" type="text" value="{{ old('nombre_servicio')}}"  name="nombre_servicio" id="nombre_servicio" 
                            ...
                            <div class="col-md-12 col-12">
                              <div class="form-group">
                                ...
                                <div class="">
                                  <label style="margin-top: 5%">Agregar descripción: &nbsp;&nbsp;<button class="btn btn-sm btn-primary btn-nuka" type="button" onclick="agregar_descripcion()" >  <div class="icon-box-icon novi-icon fa-plus "></div></button></label>
                                </div>
                              </div>
                            </div>
                          <div class="col-6">
                            <div class="form-group">
                              ...
                              <div class="col-md-10">
                                <div class="row">
                                  <div class="col-md-5 imgUp"><div class="imagePreview" style="background:url({{asset('images')}}/camara.png);  width: 150px;  height: 150px;  background-size: 100% 100%;"></div>
                      ...
                      <button style="width:100%;margin-top:5%;margin-bottom:2%"  type="submit" value="Publicar anuncio"   class="btn btn-outline btn-info btn-anis">@if(session()->get('lenguaje')=='espanol') Crear @else Create  @endif</button>
                        </form>
                    </div>                    
                  </div>
                </div>
